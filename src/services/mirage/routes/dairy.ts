...
// Methods for working with diary resources
export const create = (
  schema: any,
  req: Request
  ...
  try {
    ...
    return handleErrors(error, "Failed to create dairy.");
  }
};
...
export const updateDiary = (schema: any, req: Request): Diary | Response => {
  try {
    ...
    return handleErrors(error, "Failed to update dairy.");
  }
};
...
export const getDiaries = (schema: any, req: Request): Diary[] | Response => {
  try {
    ...
    return handleErrors(error, "Failed to get user dairies.");
  }
};

// Methods for working with diary entries
